...
angular.module("ui.mention", []).directive("uiMention", function () {
    ...
    this.render = function () {
        ...
        return "<span class='mentioned'>" + this.label(choice) + "</span>"
        ...
        // return this.delimiter + "[" + this.label(choice) + ": id=" + choice.id + "]"
        return '$#$' + choice.id;
    }, this.replace = function (mention) {
        var search = arguments.length <= 1 || void 0 === arguments[1] ? this.searching : arguments[1],
            text = arguments.length <= 2 || void 0 === arguments[2] ? ngModel.$viewValue : arguments[2];
        ...
        if ($element[0].selectionStart == $element[0].selectionEnd) {
            var text = $element.val(),
                match = _this2.searchPattern.exec(text.substr(0, $element[0].selectionStart));

app.controller('permissions', function ($scope, $http, RequestSalaryPermissionSvc) {
    ...
    $scope.init = () => {
        ...
        $scope.ajax_get_list_request_salary_permissions();
    }

    $scope.ajax_get_list_request_salary_permissions = () => {
        RequestSalaryPermissionSvc.getListRequestSalaryPermissions($scope.filter).then(r => {
    ...
    $scope.savePermission = () => {
        ...
        RequestSalaryPermissionSvc.createRequestSalaryPermissions($scope.permission).then(r => {
        ...
        // $http.post(base_url + 'request_salary_permissions/ajax_add_permission', JSON.stringify({ permission: $scope.permission})).then(r => {
    ...
    $scope.change_active_permission_in_list = (item) => {
        ...
        RequestSalaryPermissionSvc.updateActive(data).then(r => {}).catch(e => {
            toastr["error"]("Đã có lỗi xảy ra!!!");
        });
    }
    ...
    $scope.updatePermission = () => {
        ...
        RequestSalaryPermissionSvc.updateRequestSalaryPermissions($scope.permission).then(r => {
            $('#modalPermission').modal('hide');
            $scope.ajax_get_list_request_salary_permissions();
        }).catch(e => {
            toastr["error"]("Đã có lỗi xảy ra!!!");
    ...
    $scope.ChangeCompany = () => {
        RequestSalaryPermissionSvc.getListUserWithCompany($scope.permission.company_id).then(r => {
